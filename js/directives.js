    ...
    return {
        link: function(scope, element) {
            var listener = function(event, toState, toParams, fromState, fromParams) {
                ...
                var title = (window.location.href.indexOf('oscar') > -1 ? 'Oscar' : 'Valeters' ) + ' | Valet Parking Application';
                // Create your own title pattern
                if (toState.data && toState.data.pageTitle) title = (window.location.href.indexOf('oscar') > -1 ? 'Oscar' : 'Valeters' ) +' | ' + toState.data.pageTitle;
                $timeout(function() {
                    element.text(title);
                });
            };
