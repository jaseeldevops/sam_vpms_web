app.controller('AppCtrl', function($scope, $ionicModal, $rootScope, $ionicPopover, $timeout, ConnectivityMonitor, localStorageService, notificationService, $state) { // ConnectivityMonitor 
